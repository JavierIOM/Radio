...
import { Plus, Edit3, Trash2, Radio, PoundSterling, Calendar, Hash, Smartphone, Wifi, Zap, ScanLine, Mic } from 'lucide-react';
...
const HamRadioInventory = () => {
  ...
  const getCategoryIcon = (category) => {
    switch (category) {
      ...
      case 'Power Supply':
        return <PoundSterling className="h-5 w-5 text-red-400" />;
      case 'Scanner':
